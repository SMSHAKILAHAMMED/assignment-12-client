...
const Footer = () => {
    return (
        <footer className="container mx-auto bg-black text-white px-4 divide-y dark:bg-gray-100 dark:text-gray-800">
	...
	<div className="py-6 text-sm text-center dark:text-gray-600">© All rights reserved Copyright 2020 </div>
</footer>
    );
};
